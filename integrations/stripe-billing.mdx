...
SubPirate offers four subscription tiers:

| Tier | Monthly Price | Annual Price | Features |
|------|---------------|--------------|----------|
| **Starter** | $19.99/mo | TBD | Basic features, limited quotas |
| **Creator** | $37.99/mo | TBD | Enhanced features, higher quotas |
| **Pro** | $67.99/mo | TBD | Full features, professional quotas |
| **Agency** | Contact Us | Contact Us | Enterprise features (archived in Stripe) |
...
<Steps>
  ...
  <Step title="Create Products and Prices">
    ...
    ### Starter Product
    - **Name:** SubPirate Starter
    - **Metadata:** `tier` = `starter`
    - **Prices:**
      - Monthly: $19.99 recurring
      - Annual: TBD recurring
    
    ### Creator Product
    - **Name:** SubPirate Creator
    - **Metadata:** `tier` = `creator`
    - **Prices:**
      - Monthly: $37.99 recurring
      - Annual: TBD recurring
